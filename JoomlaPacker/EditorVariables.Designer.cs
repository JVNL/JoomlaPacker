namespace JoomlaPacker
{
	partial class EditorVariables
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(EditorVariables));
			...
			// Arguments
			// 
			this.Arguments.HeaderText = "Value";
			...
			this.Name = "EditorVariables";
			this.Text = "Joomla Packer - Variables";
			this.Load += new System.EventHandler(this.EditorVariables_Load);
